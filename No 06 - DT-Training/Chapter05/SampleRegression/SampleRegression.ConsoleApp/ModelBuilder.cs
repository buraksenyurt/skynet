...
namespace SampleRegression.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Projects\skynet\No 06 - DT-Training\Chapter05\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"C:\Projects\skynet\No 06 - DT-Training\Chapter05\SampleRegression\SampleRegression.Model\MLModel.zip";
